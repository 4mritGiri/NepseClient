...
setup(
   ...
   version='1.0.0',
   author='Amrit Giri',
   author_email='amrit.dev@gmail.com',
   description='A comprehensive Python client for Nepal Stock Exchange (NEPSE) API',
   long_description=long_description,
   long_description_content_type='text/markdown',
   url='https://github.com/4mritgiri/nepse-client',
   project_urls={
      'Bug Reports': 'https://github.com/4mritgiri/nepse-client/issues',
      'Source': 'https://github.com/4mritgiri/nepse-client',
