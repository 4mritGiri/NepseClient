...
class _DummyIDManager:
   ...
   def convertToDateTime(self, date_time_str):
      # Remove any extra decimal places beyond microseconds
      if '.' in date_time_str:
         # Use regex to ensure we only have up to 6 decimal places
         ...
         if match:
               ...
               if decimal_part:
                  ...
                  try:
                     ...
                     pass
               # If microsecond parsing fails, fall back to second-level parsing
